...
int main(void)
{
    ...
    switch (currentScreen)
    {
        ...
        case NETWORKING: UnloadNetworkingScreen(); break;
        case CONNECTING: UnloadConnectingScreen(); break;
        default: break;
    }
...
static void ChangeToScreen(int screen)
{
    ...
    switch (screen)
    {
        ...
        case NETWORKING: InitNetworkingScreen(); break;
        case CONNECTING: InitConnectingScreen(); break;
        default: break;
    }
...
static void UpdateDrawFrame(void)
{
    ...
    if (!onTransition)
    {
        switch(currentScreen)
        {
            ...
            case TITLE:
            {
                ...
                if (FinishTitleScreen() == 1) TransitionToScreen(NETWORKING);
            } break;
            case OPTIONS:
            {
                UpdateOptionsScreen();
            ...
            {
                UpdateEndingScreen();
                if (FinishEndingScreen() == 1) TransitionToScreen(NETWORKING);
            } break;
            case NETWORKING:
            {
                UpdateNetworkingScreen();

                if (FinishNetworkingScreen() == 1) TransitionToScreen(CONNECTING);
            } break;
            case CONNECTING:
            {
                UpdateConnectingScreen();

                if (FinishConnectingScreen() == 1) TransitionToScreen(GAMEPLAY);
            } break;
            default: break;
        }
    }
    ...
    BeginDrawing();
        ...
        switch(currentScreen)
        {
            ...
            case NETWORKING: DrawNetworkingScreen(); break;
            case CONNECTING: DrawConnectingScreen(); break;
            default: break;
        }
